...
public interface ScoreService {
     ...
     * @return 成绩列表（包含班级信息）
     */
    List<Map<String, Object>> findByExamCodeAndClazz(Integer examCode, String clazz);
     ...
     * @return 分页结果（包含班级信息）
     */
    IPage<Map<String, Object>> findByExamCodeAndClazz(Page<?> page, Integer examCode, String clazz);
}