...
) ENGINE = InnoDB AUTO_INCREMENT = 9991 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '管理员信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 20190023 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20230001, '2023年上期期末考试', '计算机网络', 1001, '2023-03-21', 90, '2023', '1', '计算机科学与技术', '软件工程学院', 86, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230002, '2023年上期期末考试', '数据库理论', 1002, '2023-03-07', 90, '2023', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230003, '2023年下期期末考试', '数据结构', 1003, '2023-02-27', 90, '2023', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230005, '2023年上期期末考试', '计算机导论', 1004, '2023-03-14', 90, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230006, '2023年上期期末考试', '软件工程', 1005, '2023-03-21', 120, '2023', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230007, '2023年上期期末考试', '操作系统', 1006, '2023-03-13', 120, '2023', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230008, '2023年下期期末考试', 'C语言', 1007, '2023-03-13', 120, '2023', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230009, '2023年上期期末考试', '高等数学', 1008, '2023-03-07', 90, '2023', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20230013, '测试', '测试', 1009, '2023-04-24', 120, '2023', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。');
INSERT INTO `exam_manage` VALUES (20230014, 'Java程序设计', 'Java程序设计', 1010, '2023-03-01', 60, '2023', NULL, '软件工程', '计算机学院', 100, '期末考试', '请规范作答');
INSERT INTO `exam_manage` VALUES (20230015, '考试', 'C#', 1011, '2023-03-13', 5, '2023', NULL, '软件工程', '计算机学院', 30, '期末考', '请规范作答2');
INSERT INTO `exam_manage` VALUES (20230016, '高等数学考试', '高等数学', 1012, '2023-03-20', 90, '2023', NULL, '数学工程', '数学院', NULL, '期末考试', NULL);
INSERT INTO `exam_manage` VALUES (20230017, '程序测试', '计算机网络', 1013, '2023-03-21', 90, '2023', NULL, '软件工程', '计算机学院', 0, '期末', NULL);
INSERT INTO `exam_manage` VALUES (20230018, '333', '333', 1014, '2023-03-22', 90, '2023', NULL, '333', '333', NULL, '333', '333');
INSERT INTO `exam_manage` VALUES (20230024, '测试', '计算机网络', 1015, '2023-11-18', 90, '2023', NULL, '网络工程', '计算机学院', NULL, '期中测试', '沉着应试');
INSERT INTO `exam_manage` VALUES (20230025, '测试', '测试', 1016, '2023-11-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试');
INSERT INTO `exam_manage` VALUES (20230026, '测试', '测试2', 1017, '2023-11-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试');
INSERT INTO `exam_manage` VALUES (20230027, '测试', '测试3', 1018, '2023-11-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试');
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '留言表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10034 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = Dynamic;
...
INSERT INTO `multi_question` VALUES (10004, '计算机网络', 'DHCP(        )报文的目的IP地址为255.255.255.255', 'DhcpDiscover', 'DhcpOffer', 'DhcpAck', 'DhcpNack', 'A', NULL, 2, '应用层', '2');
...
INSERT INTO `paper_manage` VALUES (1015, 1, 10005);
INSERT INTO `paper_manage` VALUES (1015, 1, 10012);
INSERT INTO `paper_manage` VALUES (1015, 2, 10015);
INSERT INTO `paper_manage` VALUES (1015, 2, 10017);
INSERT INTO `paper_manage` VALUES (1015, 3, 10010);
INSERT INTO `paper_manage` VALUES (1015, 3, 10001);
INSERT INTO `paper_manage` VALUES (1015, 1, 10015);
INSERT INTO `paper_manage` VALUES (1015, 1, 10001);
INSERT INTO `paper_manage` VALUES (1015, 1, 10005);
INSERT INTO `paper_manage` VALUES (1015, 1, 10006);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '回复表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `score`  (
  ...
  `ptScore` int(0) NULL DEFAULT NULL COMMENT '是否及格，0不及格，1及格',
  `etScore` int(0) NULL DEFAULT NULL COMMENT '成绩',
  `score` int(0) NULL DEFAULT NULL COMMENT '试卷满分',
  `answerDate` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '答题日期',
  PRIMARY KEY (`scoreId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 149 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 20225009 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '学生信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20224001, '王六', '2023', '计算机科学与技术', '2', '软件工程学院', '13585411132', 'gblw2331@163.com', '123456', '500234597988722353', '男', '2');
INSERT INTO `student` VALUES (20224084, '张三', '2023', '计算机科学与技术', '2', '软件工程学院', '13658555557', '13658555557@sina.cn', '123456', '500574111114022353', '男', '2');
INSERT INTO `student` VALUES (20225003, '李四', '2023', '信息工程', '1', '软件工程学院', '15512345425', '15512345425@163.com', '123456', '500237781114022353', '男', '2');
INSERT INTO `student` VALUES (20225007, '王五', '2023', '网络工程', '1', '软件工程学院', '18777778457', '187777457@163.com', '123456', '500234565548022353', '女', '2');
INSERT INTO `student` VALUES (20225008, '徐七', '2023', '信息工程', '2', '软件工程学院', '15111619564', '1511164@163.com', '123456', '500234111114022353', '男', '2');
INSERT INTO `student` VALUES (20225009, '郑八', '2023', '软件工程', '1班', '计算机学院', '13355555555', '123@qq.com', '123456', '445444444444444444', '男', '2');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '张小风', '软件工程学院', '男', '13500008441', '1322@163.com', '123456', '465111111111111111', '讲师', '1');
INSERT INTO `teacher` VALUES (20081002, '王大志', '软件工程学院', '男', '12312213128', '1231221312@163.com', '123456', '455111111111111233', '讲师', '1');
...
INSERT INTO `teacher` VALUES (20081006, '测试', '测试', '测试', '测试', NULL, '测试', '测试', '测试', '1');
